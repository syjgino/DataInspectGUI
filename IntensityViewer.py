# -*- coding: utf-8 -*-
"""
Created on Wed Nov 18 15:05:52 2020
...
class App:
    ...
    def readmzml(self):
        ...
        #read standard dict
        std_dict = {}
        std_dict['1'] = pd.read_excel(self.stdkey.get('1.0', 'end-1c'), sheet_name = 'Method1', header=0, index_col=0, na_values='.').to_dict()
        std_dict['2'] = pd.read_excel(self.stdkey.get('1.0', 'end-1c'), sheet_name = 'Method2', header=0, index_col=0, na_values='.').to_dict()
